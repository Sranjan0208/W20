...
export default function Home() {
  ...
  <div class="container flex flex-wrap px-5 py-24 mx-auto items-center">
    <div class="md:w-1/2 md:pr-12 md:py-8 md:border-r md:border-b-0 mb-10 md:mb-0 pb-10 border-b border-gray-200">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Empowering Women to Lead: Lets Make History Together</h1>
      <p class="leading-relaxed text-base">
Our aim is to remove all barriers to women led development and ensure an enabling environment & ecosystem for women to thrive, transcend and transform their lives as well as others.</p>
